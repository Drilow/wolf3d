...
/*   Updated: 2018/01/28 14:38:08 by adleau           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_starting_pos(t_engine *eng, t_w3dmap *map)
{
	...
	map->camera.fov = 60;
	map->camera.range_start = map->camera.orientation - map->camera.fov / 2;
	map->camera.range_end = map->camera.orientation + map->camera.fov / 2;
