...
/*   Updated: 2018/01/29 06:07:52 by adleau           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				init_parse(t_parser *parse)
{
	...
	parse->map.camera.player.x = 50;
	parse->map.camera.player.y = 5;
	parse->map.camera.dist_screen = (WIN_WD / 2) / tan(30 * M_PI / 180);
	printf("cam %d\n", parse->map.camera.dist_screen);
}
